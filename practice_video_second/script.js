async function getCurrentWeatherByCity(city) {
    const data = await fetch(`http://api.weatherapi.com/v1/current.json?key=dea1d07624d04a22b25195825242311&q=${city}&aqi=no`)
...
async function getForecastByCity(city) {
    const data = await fetch(`http://api.weatherapi.com/v1/forecast.json?key=dea1d07624d04a22b25195825242311&q=${city}&days=1&aqi=no&alerts=no`)
